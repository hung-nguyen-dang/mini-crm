...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    { className, variant, size, asChild = false, loading, external, startDecorator, ...props },
    ref,
  ) => {
    ...
    return (
      <Comp className={cn(buttonVariants({ variant, size, className }))} ref={ref} {...props}>
        ...
        {startDecorator && !loading ? startDecorator : null}
        {props.children}
        {variant === 'link' && external ? <ExternalLink /> : null}
      </Comp>
    )
  },
)
